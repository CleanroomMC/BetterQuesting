...
public class ConfigHandler {
    ...
    public static void initConfigs() {
        ...
        BQ_Settings.viewMode = config.getBoolean("View mode", Configuration.CATEGORY_GENERAL, false, "If view mode enabled, User can view most quests (Hidden or Secret quests remain unviewable)");
