...
public class ConfigHandler {
    ...
    public static void initConfigs() {
        ...
        BQ_Settings.historyRepeatableFilter = config.getString("History Repeatable Filter", Configuration.CATEGORY_GENERAL, "SHOW_ALL", "The repeatable quest filter used by the history screen");
        BQ_Settings.historyStandardFilter = config.getString("History Standard Filter", Configuration.CATEGORY_GENERAL, "SHOW_ALL", "The standard quest filter used by the history screen");
